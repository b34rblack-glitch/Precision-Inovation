// Standard-projectile drag coefficient tables, Cd as a function of Mach number.
// Source: R.L. McCoy, "Modern Exterior Ballistics" (public domain data as
// republished by JBM Ballistics, https://www.jbmballistics.com/ballistics/downloads/downloads.shtml).
// G1: blunt flat-base reference projectile. G7: long boat-tail reference,
// the better match for modern low-drag rifle bullets.

export type DragModel = 'G1' | 'G7';

type TableRow = readonly [mach: number, cd: number];

export const G1_TABLE: readonly TableRow[] = [
...
export const G7_TABLE: readonly TableRow[] = [
...
const TABLES: Record<DragModel, readonly TableRow[]> = { G1: G1_TABLE, G7: G7_TABLE };

/** Standard-projectile Cd at a given Mach number, linearly interpolated. */
